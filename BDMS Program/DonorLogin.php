...
<head>
    ...
    <link rel="stylesheet" href="styles/DonorLogin.css">
</head>
<body style="margin: 0; padding-top: 40px; background-color: rgb(237, 66, 47);">
    ...
    <div class="DonorLoginScreen">
        <div class="DonorLoginBox">
            <div class="DonorLoginText">DONOR LOGIN</div>
            ...
            <p class="DonorSignupText">Don't have an account? <a href="DonorSignup.php">Click here to register</a></p>
        </div>
    </div>
</body>
</html>
...
if (isset($_POST["Login"])){
    ...
    if ((trim($Username) == "") || (trim($Password) == "")){
        ...
        if ($conn->connect_error){
            ...
            $stmt = "SELECT Username,Password FROM donor WHERE Username='$Username' AND Password='$Password'";
