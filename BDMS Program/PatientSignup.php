...
<body style="margin: 0; padding-top: 40px; background-color: rgb(237, 66, 47);">
    ...
    <div class="PatientSignupScreen">
        <div class="PatientSignupBox">
            <div class="PatientSignupText">PATIENT SIGNUP</div>
            ...
            <p class="PatientLoginText">Already have an account? <a href="PatientLogin.php">Click here to Login</a></p>
        </div>
    </div>
</body>
</html>
    ...
    if ((trim($FullName) == "") || (trim($Username) == "") || (trim($Password) == "") || ($Gender == "Choose Gender") || (trim($DOB) == "") || 
        ...
        if ($conn->connect_error){
            ...
            if (mysqli_num_rows($result) == 0){
                ...
                $stmt = $conn->prepare("INSERT INTO patient(Username, Name, gender, DOB, PhoneNumber, Blood_Group, Medical_History, Password) VALUES(?,?,?,?,?,?,?,?)");
